          ...
          child: Form(
            ...
            child: Column(
              children: <Widget>[
                ...
                SizedBox(height: size.height * 0.05),
                textField(_groupNameController, "Group Name", 0.07, 0.8, 25.0,
                    Colors.white),
                SizedBox(height: size.height * 0.05),
                textField(_groupBioController, "Group Description", 0.07, 0.8,
                    25.0, Colors.white),
                SizedBox(height: size.height * 0.05),
                RaisedButton(
                  onPressed: () async {
                    if (_formKey.currentState.validate()) {
                      await DatabaseService().createGroup(
                          _groupNameController.text, _groupBioController.text, auth.currentUser.uid);
