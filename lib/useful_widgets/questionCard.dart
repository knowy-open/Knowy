              ...
              children: [
                  ...
                  Padding(
                    ...
                    child: Column( children: [
                      ...
                      Padding(
                        ...
                        child: Row(children: [
                          InkWell( onTap: (){},//kişinin profiline gidecek buraya basınca
                      ...
                      Padding(
                        padding:  EdgeInsets.only(left:MediaQuery.of(context).size.height * 0.025  ),
                        child: Row(mainAxisAlignment:MainAxisAlignment.start,children: [ Text('4 min',maxLines: 1, overflow: TextOverflow.ellipsis,)],),
                      )],),
                  ),

                  Padding(padding: EdgeInsets.only(left:MediaQuery.of(context).size.width * 0.025 , ),
                  child: Container(
                ...
                Container(
                  ...
                  child: FlatButton(  onPressed: () {  },
                    child: Row(mainAxisAlignment:MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Expanded(
                        child: Text(soru[index],overflow: TextOverflow.ellipsis, maxLines:2,textAlign: TextAlign.left,
                        ),
                      )
                    ],),
                  ),
                ...
                Container(height:MediaQuery.of(context).size.height * 0.1,width:MediaQuery.of(context).size.width * 0.8  ,
                  child: Stack(children: [
                    ...
                    Positioned(top:MediaQuery.of(context).size.height * 0.04,left:MediaQuery.of(context).size.width * 0.22,child: TextButton(child: Text("10 Answered"), onPressed: (){},))
                  ],),
                )
              ],
            ),
