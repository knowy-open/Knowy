...
class ProfileBarWithoutCard extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Column(
            ...
            context,
            MaterialPageRoute(builder: (context) => Profile()),); }, //user profile
                            child: Container(
                              height:
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            onTap: () {Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => MyApp()),); }, //group profile
                            child: Container(
                              height:
                                  MediaQuery.of(context).size.height * 0.027,
                              width: MediaQuery.of(context).size.width * 0.47,
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        border:
                            Border.all(color: Colors.green[200], width: 2.0),
